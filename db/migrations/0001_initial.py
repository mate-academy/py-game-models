# Generated by Django 4.0.2 on 2024-09-16 03:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Elf', 'Elf Race'), ('Dwarf', 'Dwarf Race'), ('Human', 'Human Race'), ('Ork', 'Ork Race')], max_length=255, null=True, unique=True)),
