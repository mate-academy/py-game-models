# Generated by Django 4.0.2 on 2023-03-06 12:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Elf', 'information'), ('Dwarf', 'information'), ('Human', 'information'), ('Ork', 'information')], max_length=255, unique=True)),
