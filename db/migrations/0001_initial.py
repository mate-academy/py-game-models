# Generated by Django 4.0.2 on 2024-09-21 10:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, unique=True)),
                ('bonus', models.CharField(max_length=255, verbose_name='Bonus Description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.CharField(help_text='A short description of the player', max_length=255)),
