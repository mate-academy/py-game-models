# Generated by Django 4.0.2 on 2023-03-09 21:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, unique=True)),
                ('bonus', models.CharField(help_text='skill bonus type', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.CharField(blank=True, help_text='short description provided by a user about himself/herself.', max_length=255)),
