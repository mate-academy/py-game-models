# Generated by Django 4.0.4 on 2022-10-19 10:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Elf', 'race to play: Elf'), ('Dwarf', 'race to play: Dwarf'), ('Human', 'race to play: Human'), ('Ork', 'race to play: Ork')], max_length=255, unique=True)),
                ('description', models.TextField(blank=True)),
            ],
        ),
        migrations.CreateModel(
