# Generated by Django 4.0.2 on 2022-10-05 17:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guild', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='guild_id', to='db.guild')),
                ('race', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.race')),
            ],
        ),
    ]
