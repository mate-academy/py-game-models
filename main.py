...
def main() -> None:
    ...
    for player in data_in_file:
        ...
        race_name = race["name"].capitalize()
        ...
        Player.objects.create(
            ...
            email=email,
            bio=bio,
            race=Race(name=race_name, description=race_description).save(),
            guild=Guild(name=guild_name, description=guild_description).save()
        )
        break
